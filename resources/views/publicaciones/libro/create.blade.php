...
@section("titulo", "SIGAA - Carga de libro")
...
<form method="POST" action="/libro" id="formulario-libro">
    @csrf

    <div class="card my-3">
        <h4 class="card-header">Formulario de carga para libro</h4>
        <div class="card-body">
            ...
            <div class="row form-group">
                <div class="col-md-4">
                    ...
                    <input type="number" name="ISBN" class="form-control" placeholder="ISBN 10 o 13, sin guiones"
                        value="{{ old('ISBN') }}">
                </div>
